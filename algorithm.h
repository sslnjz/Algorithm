...
namespace algorithm
{
     ...
     * ——————————————————————————————————————————————————————————————————————————————
     * |  O(1) | O(log n) |  O(n) |  O(n log n) |  O(n²)  | O(n³) | O(n^k)| O(2^n) |
     * ——————————————————————————————————————————————————————————————————————————————
     ...
     * —————————————————————————————————————————————————————————————————————————————————
     * | Merge          |  n log n |   n log n   |  n log n  |  worst n   |    yes     |
     * —————————————————————————————————————————————————————————————————————————————————
     * | In-place Merge |    --    |     --      | n(log n)² |     1      |    yes     |
     * —————————————————————————————————————————————————————————————————————————————————
     * | Quick          |  n log n |   n log n   |    n²     |   Av:log n | no(typical)|
     * —————————————————————————————————————————————————————————————————————————————————
